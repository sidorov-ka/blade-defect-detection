...
**Note**: Data will be automatically pulled when running `train` command if not available locally. Progress indicator will show during download (may take several minutes for ~30GB dataset).
